...
fn eval_table<H: InterpreterHandler>(
	...
	static TABLE: [fn(state: &mut Machine, opcode: Opcode, position: usize) -> Control; 256] = {
		...
		table_elem!(DIV, state, op2_u256_fn!(state, self::arithmetic::div, position));
		table_elem!(SDIV, state, op2_u256_fn!(state, self::arithmetic::sdiv, position));
		table_elem!(EXP, state, op2_u256_fn!(state, self::arithmetic::exp, position));
		table_elem!(
			SIGNEXTEND,
			state,
		...
		table_elem!(SLT, state, op2_u256_fn!(state, self::bitwise::slt, position));
		table_elem!(SGT, state, op2_u256_fn!(state, self::bitwise::sgt, position));
		table_elem!(EQ, state, op2_u256_bool_ref!(state, eq));
		table_elem!(ISZERO, state, op1_u256_fn!(state, self::bitwise::iszero, position));
		...
		table_elem!(NOT, state, op1_u256_fn!(state, self::bitwise::not, position));
		table_elem!(BYTE, state, op2_u256_fn!(state, self::bitwise::byte, position));
		table_elem!(SHL, state, op2_u256_fn!(state, self::bitwise::shl, position));
		table_elem!(SHR, state, op2_u256_fn!(state, self::bitwise::shr, position));
		table_elem!(SAR, state, op2_u256_fn!(state, self::bitwise::sar, position));
		...
		table_elem!(PUSH0, state, position, self::misc::push0(state, position));
		...
		table_elem!(MOD, state, op2_u256_fn!(state, self::arithmetic::rem, position));
		table_elem!(SMOD, state, op2_u256_fn!(state, self::arithmetic::srem, position));
		...
		table_elem!(ADDMOD, state, op3_u256_fn!(state, self::arithmetic::addmod, position));
		table_elem!(MULMOD, state, op3_u256_fn!(state, self::arithmetic::mulmod, position));
		...
		table_elem!(CODECOPY, state, position, self::misc::codecopy(state, position));
		table_elem!(CALLDATACOPY, state, position, self::misc::calldatacopy(state, position));
		table_elem!(DUP1, state, position, self::misc::dup(state, 1, position));
		table_elem!(DUP2, state, position, self::misc::dup(state, 2, position));
		table_elem!(DUP3, state, position, self::misc::dup(state, 3, position));
		table_elem!(DUP4, state, position, self::misc::dup(state, 4, position));
		table_elem!(DUP5, state, position, self::misc::dup(state, 5, position));
		table_elem!(DUP6, state, position,self::misc::dup(state, 6, position));
		table_elem!(DUP7, state, position,self::misc::dup(state, 7, position));
		table_elem!(DUP8, state, position, self::misc::dup(state, 8, position));
		table_elem!(DUP9, state, position, self::misc::dup(state, 9, position));
		table_elem!(DUP10, state, position, self::misc::dup(state, 10, position));
		table_elem!(DUP11, state, position, self::misc::dup(state, 11, position));
		table_elem!(DUP12, state, position, self::misc::dup(state, 12, position));
		table_elem!(DUP13, state, position, self::misc::dup(state, 13, position));
		table_elem!(DUP14, state, position, self::misc::dup(state, 14, position));
		table_elem!(DUP15, state, position, self::misc::dup(state, 15, position));
		table_elem!(DUP16, state, position, self::misc::dup(state, 16, position));
		table_elem!(SWAP1, state, position, self::misc::swap(state, 1, position));
		table_elem!(SWAP2, state, position, self::misc::swap(state, 2, position));
		table_elem!(SWAP3, state, position, self::misc::swap(state, 3, position));
		table_elem!(SWAP4, state, position, self::misc::swap(state, 4, position));
		table_elem!(SWAP5, state, position, self::misc::swap(state, 5, position));
		table_elem!(SWAP6, state, position, self::misc::swap(state, 6, position));
		table_elem!(SWAP7, state, position, self::misc::swap(state, 7, position));
		table_elem!(SWAP8, state, position, self::misc::swap(state, 8, position));
		table_elem!(SWAP9, state, position, self::misc::swap(state, 9, position));
		table_elem!(SWAP10, state, position,  self::misc::swap(state, 10, position));
		table_elem!(SWAP11, state, position, self::misc::swap(state, 11, position));
		table_elem!(SWAP12, state, position, self::misc::swap(state, 12, position));
		table_elem!(SWAP13, state, position, self::misc::swap(state, 13, position));
		table_elem!(SWAP14, state, position, self::misc::swap(state, 14, position));
		table_elem!(SWAP15, state, position, self::misc::swap(state, 15, position));
		table_elem!(SWAP16, state, position, self::misc::swap(state, 16, position));
		table_elem!(RETURN, state, position, self::misc::ret(state, position));
		table_elem!(REVERT, state, position, self::misc::revert(state, position));
		...
		table_elem!(JUMP, state, position, self::misc::jump(state, position));
		table_elem!(JUMPI, state, position, self::misc::jumpi(state, position));
		table
	};
	let mut pc = position;
	handler.before_eval();
